...
export const Cart = ({ start, id }: Props) => {
    ...
    return (
        <div key={id} className={`border rounded-md p-5  transition-all ${movieId === id ? 'bg-teal-600 translate-x-3  text-white  ' : 'hover:bg-slate-200 bg-white'} cursor-pointer  `} onClick={() => selectEvent(id)}>
